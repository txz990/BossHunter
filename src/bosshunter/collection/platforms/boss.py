...
# BOSS 直聘「公司规模」筛选 URL 参数编码（与 ?scale=301,302,... 对应）。
# 对应 BOSS 内部固定值，按 0-20人 → 10000人以上 递增。
_COMPANY_SIZE_SCALE_CODES = {
    "0-20人": 301,
    "20-99人": 302,
    "100-499人": 303,
    "500-999人": 304,
            ...
            for city, city_code, keyword in combos:
                ...
                for page in range(1, request.max_pages + 1):
                    ...
                    if request.company_sizes:
                        scale_codes = [
                            str(_COMPANY_SIZE_SCALE_CODES[s])
                            for s in request.company_sizes
                            if s in _COMPANY_SIZE_SCALE_CODES
                        ]
                        if scale_codes:
