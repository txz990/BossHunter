...
from bosshunter.config import AI_SERVICE_PRESETS, CITY_CODES, load_config, remove_retired_collection_settings
...
def api_ai_preset_get():
	...
	try:
		...
		if preset is None:
			return _json_response({"ok": False, "error": "未找到指定的 AI 预设"}, 404)
